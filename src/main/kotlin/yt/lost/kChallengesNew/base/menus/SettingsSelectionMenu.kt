    ...
    init {
        ...
        this.inventory.setItem(
            ...
            createGuiItem(
                ...
                "§6Ultra Hardcore",
                "§8Ultrahardcore ist ${if (settings.uhc){
                    "§aAn"
                }else {
                    "§cAus"
                }}",
        ...
        this.inventory.setItem(
            ...
            createGuiItem(
                ...
                "${ChatColor.DARK_GRAY}Backpack ist ${if (settings.backpack){
                    "${ChatColor.GREEN}An"
                }else {
                    "${ChatColor.RED}Aus"
                }}",
        ...
        this.inventory.setItem(
            ...
            createGuiItem(
                ...
                "§6Sterben",
                "§8Sterben ist ${if (settings.canDie){
                    "§aErlaubt"
                }else {
                    "§cnicht Erlaubt"
                }}",
                ...
                Material.GOLDEN_APPLE -> {
                    ...
                    this.inventory.setItem(
                        ...
                        createGuiItem(
                            Material.GOLDEN_APPLE,
                            "§6Ultra Hardcore",
                            "§7Ultrahardcore ist ${if (settings.uhc){
                                "§aAn"
                            }else {
                                "§cAus"
                            }}",
                ...
                Material.REDSTONE -> {
                    for (player in Bukkit.getOnlinePlayers()) {
                        if ((player.getAttribute(Attribute.MAX_HEALTH)?.value)!! - 1.0 < 1.0) {
                            clicker.sendMessage("${ChatColor.RED}Die Maximalen Leben dürfen nicht kleiner als 0.5♥ sein")
                            return
                        }
